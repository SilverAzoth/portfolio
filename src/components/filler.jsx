                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-8">
                                <div className="modal-body">
                                    ...
                                    <p className="item-intro text-muted">This React Bootstrap Portfolio Application</p>
                                    ...
                                    <button className="btn btn-primary" data-dismiss="modal" type="button" onClick={onClose}>
                                        Close Project
                                    </button>
                                </div>
                            </div>
